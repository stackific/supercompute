import { clampChroma, formatHex, modeLrgb, modeOklch, modeRgb, useMode, wcagContrast, type Oklch } from "culori/fn";
...
export const oklchToHex = (l: number, c: number, h: number) => oklchColorToHex(oklchColorFromParts(l, c, h));
